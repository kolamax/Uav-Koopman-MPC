...
% 5. Tests disturbance rejection capabilities
%
% ========================================================================
...
while t < tf
    ...
    dyn = @(tt,xx) dynamics_3D_disturbed(xx,u,tt);
...
function dx = dynamics_3D_disturbed(x,u,t)
...
dx(2) = dx(2) + Fx_wind/Mtot;
dx(4) = dx(4) + Fy_wind/Mtot;
dx(6) = dx(6) + Fz_wind/Mtot;
...
data.meta.N = N;
data.meta.model = "KOOPMAN_WIND";

save('exp_koopman_wind.mat', 'data');
